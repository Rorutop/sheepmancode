	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:Int = 0)
		{
			...
			switch (PlayState.SONG.noteStyle)
			{
				...
				default:
						...
						var fuckingSussy = Paths.getSparrowAtlas('NOTE_electric');
						...
						switch(noteType)
						{
							case 2:
							{
								...
								animation.addByPrefix('greenScroll', 'NOTE_electric electricUP');
								animation.addByPrefix('redScroll', 'NOTE_electric electricRIGHT');
								animation.addByPrefix('blueScroll', 'NOTE_electric electricDOWN');
								animation.addByPrefix('purpleScroll', 'NOTE_electric electricLEFT');
